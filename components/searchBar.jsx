...
const SearchWithFocus = () => {
  ...
  const data = [
    ...
    { "name": 'New Delhi', "icon": stateIco2 , "id":"U9qUPmAlGZ5qxisaXlP4" },
    { "name": 'Telangana', "icon": stateIco3 , "id":"8BZzWCFcgqIUCV1DRyMq" },
    { "name": 'Bihar', "icon": stateIco4 , "id": "TlPNv8uGMXw4JLUNGWpx"},
    { "name": 'Assam', "icon": stateIco5 , "id":"iRB2o8AC3LgX0MtVKsKB" },
    { "name": 'Hariyana', "icon": stateIco6 , "id": "f72f4p9xSn7ajivaVPbk"},
    { "name": 'Tamil Nadu', "icon": stateIco7 , "id":"yujEAbWBCNbcoChvBzHx" }
  ];
          ...
          {filteredData.length > 0 ? (
            filteredData.map((item, index) => (
              ...
              > 
                ...
                <Image src={item.icon} width="30" height="30" alt="blah" className='h-fit dark:invert ' unoptimized/>
                </div>
              </Link>
            ))
          ) : (
