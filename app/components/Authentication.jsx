    ...
    return (
        <div    className="cursor-none   flex  justify-center items-center h-screen w-screen">
            ...
            <div    className="cursor-none   dark:border-[2px] py-5 shadow-md dark:border-[#640303] rounded-sm shrink-0 justify-between flex-col items-stretch w-[90vw] md:w-[45vw] flex min-h-[80vh] mx-4 bg-[#89a3a8c9]   dark:bg-[#1e0700]  ">
                ...
                <div    className="cursor-none flex gap-5 w-full my-3 justify-center ">
                    <button    className="cursor-none  rounded-lg  pr-2 bg-white text-lg  text-black flex items-center  font-serif " onClick={handleGoogleSignIn}><Image src="https://cdn.freebiesupply.com/logos/large/2x/google-icon-logo-png-transparent.png" width={50} height={50}    className="cursor-none scale-[0.5]" alt="" />Google</button>
                </div>
                ...
                <div    className="cursor-none   px-14 flex justify-between ">
                    ...
                    <Link href="/"    className="cursor-none    flex justify-center items-center bg-blfdsck text-[#031a2c] dark:text-[#ffd867]  w-5 h-5 roundsfded-full"><FaHome    className="cursor-none    w-10" /></Link>
                </div>
            </div>
        </div>
    )
