...
const StateSectoin = (data) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center'>
      ...
      <section className='flex justify-center my-10 flex-wrap'>
      <h1 className='amsterdam bg-origin-border pt-10 text-[#ffd867] mt-50 text-center w-full text-[4rem] mx-auto mt'>
            Places to visit in India
          </h1>
        {
          JsonFile.IndiaPackages.map((each, index) => (
            <div key={each.placeName} className='flex placeDiv opacrity-0 culture border-[2px] border-[#640303] rounded-sm shrink-0 justify-between w-[90vw] md:w-[45vw] m-4 bg-[#1e0700] '>
              <div className='overflow-hidden flex items-center justify-start w-[126vw]'>
